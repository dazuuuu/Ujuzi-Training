...
<div class="space-y-6">
  <section class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
    <div>
      ...
      <p class="mt-1 max-w-2xl text-sm font-medium text-neutral-600">List the campuses or locations for <?= e($currentUser['organisation_name'] ?? 'your organisation') ?>. Title and location are required; a cover image is optional.</p>
    </div>
    ...
    <div class="course-grid">
      <?php foreach ($branches as $branch): ?>
        <article class="course-card">
          ...
          <?php endif; ?>
          <h2 class="font-serif-heading text-xl font-bold"><?= e($branch['title']) ?></h2>
